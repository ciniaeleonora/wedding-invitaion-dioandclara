...
import RJ770384 from '../assets/RJ770384.jpg'
import RJ788507 from '../assets/RJ788507.jpg'
import RJ788803 from '../assets/RJ788803.jpg'
import RJ770441 from '../assets/RJ770441.jpg'
import RJ788380 from '../assets/RJ788380.jpg'
import RJ788410 from '../assets/RJ788410.jpg'
import RJ770532 from '../assets/RJ770532.jpg'
import RJ788621 from '../assets/RJ788621.jpg'
import RJ788460 from '../assets/RJ788460.jpg'
import RJ770199 from '../assets/RJ770199.jpg'
  ...
  return (
    <div className='container' id='gallery'>
      ...
      <div className = 'row' style={{display: "inline-block"}}>
        ...
        <img className="img-fluid rounded-3" alt='lala-dio' src={RJ770532} style={{width:'50%', marginBottom: '2vh'}}/>
        <img className="img-fluid rounded-3" alt='lala-dio' src={RJ788803} style={{width:'50%', marginBottom: '2vh'}}/>
        ...
        <img className="img-fluid rounded-3" alt='lala-dio' src={DSC_5665} style={{width: '33%', marginBottom: '2vh'}}/>
        <img className="img-fluid rounded-3" alt='lala-dio' src={RJ770384} style={{width: '33%', marginBottom: '2vh'}}/>
        <img className="img-fluid rounded-3" alt='lala-dio' src={RJ788507} style={{width: '33%', marginBottom: '2vh'}}/>
